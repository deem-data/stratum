...
normalize_l2 = getattr(native, "normalize_l2_dense", None) if native else None
normalize_l1 = getattr(native, "normalize_l1_dense", None) if native else None
normalize_max = getattr(native, "normalize_max_dense", None) if native else None
normalize_l2_inplace = getattr(native, "normalize_l2_inplace", None) if native else None
normalize_l1_inplace = getattr(native, "normalize_l1_inplace", None) if native else None
normalize_max_inplace = getattr(native, "normalize_max_inplace", None) if native else None